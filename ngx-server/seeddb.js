// Import the installed Node packages
const sqlite3 = require('sqlite3').verbose()
const fetch = require('node-fetch');

// Connect to the created database file with read and write permissions
...
// Fetch the dummy sales data from a GitHub repository and insert it into the SQLite database
fetch("https://raw.githubusercontent.com/kimanikevin254/dummy-sales-data/main/salesdata.json")
    ...
    database.serialize(() => {
            ...
            // Loop through the fetched sales data and insert it into the SQLite database
            ...
            // Read data from the database and display it in the console
